...
// スラッグから都道府県名を取得
$slug_to_name = array_flip( array_map( 'mama_gen_prefecture_to_slug', mama_gen_get_prefectures() ) );
$prefecture_name = isset( $slug_to_name[ $prefecture_slug ] ) ? $slug_to_name[ $prefecture_slug ] : '';
