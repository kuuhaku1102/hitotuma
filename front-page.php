...
?>
  ...
  <section class="hero-section">
    <div class="hero-content">
      ...
      <p class="hero-description">あなたの地域で素敵な人妻との出会いを見つけませんか？<br>都道府県別に厳選された女性をご紹介しています。</p>
    </div>
  </section>

  <!-- トップページ用SEOコンテンツ -->
  <?php if ( $top_seo_contents->have_posts() ) : ?>
    <section class="top-seo-section">
      <div class="seo-content-list">
        <?php while ( $top_seo_contents->have_posts() ) : $top_seo_contents->the_post(); ?>
          <article class="seo-content-item">
            <h3><?php the_title(); ?></h3>
  ...
  <section class="features-section">
    ...
    <div class="features-grid">
      <div class="feature-card">
        ...
        <h3>地域密着型</h3>
        <p>都道府県別に細かく分類されているので、あなたの地域で出会いを探せます。</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon">💝</div>
        <h3>厳選された女性</h3>
        <p>プロフィールが充実した、本気で出会いを求めている女性のみを掲載しています。</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon">🔒</div>
        <h3>安心・安全</h3>
        <p>プライバシーに配慮した運営で、安心してご利用いただけます。</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon">📱</div>
        <h3>スマホ対応</h3>
        <p>スマートフォンからでも快適に閲覧・利用できるレスポンシブデザインです。</p>
      </div>
    </div>
  </section>
